...
class _RegistrasiPageState extends State<RegistrasiPage> {
  ...
  void _submit() {
    ...
    RegistrasiBloc.registrasi(
      ...
      passwordKonfirmasi: _passwordKonfirmasiTextboxController.text,
    ).then(
      (value) {
        setState(() {
          _isLoading = false;
        ...
        if (value.code == 200) {
          ...
          showDialog(
            ...
            builder: (BuildContext context) => AlertDialog(
              ...
              content: Text("Registrasi gagal: ${value.data}"),
              actions: [
                TextButton(
      ...
      onError: (error) {
        ...
        showDialog(
          ...
          builder: (BuildContext context) => AlertDialog(
            title: const Text("Gagal"),
            content: const Text("Registrasi gagal, silahkan coba lagi"),
            actions: [
              TextButton(
                onPressed: () => Navigator.pop(context),
                child: const Text("OK"),
